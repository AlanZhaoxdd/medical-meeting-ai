...
import { Files, RefreshRight } from '@element-plus/icons-vue'
  ...
  <section>
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">选择已生成 AI 纪要的会议，导出文字纪要、汇报 PPT 或数据图表。</p>
      </div>
      ...
      <el-table v-loading="loading" :data="result.items" row-key="id">
        ...
        <el-table-column label="操作" width="240">
          <template #default="{ row }">
            ...
            <el-button link type="primary" @click="openAnalysis(row)">AI 纪要分析</el-button>
          </template>
        </el-table-column>
        <template #empty>
